      ...
      <div className="offcanvas-body">
        {props.carrinhoItem.length === 0 ? (
          ...
          <>
            ...
            />
            <div 
            className="d-flex justify-content-between text-light fs-4"
            >
            <strong>Total:</strong>
            ...
            <button 
            id='addCarrinho' 
            className="btn btn-sucess desconto border-0 w-100 mt-2 fs-5"
            data-bs-toggle="offcanvas"
            data-bs-target="#carrinhoOffCanvas"
            onClick={goToCheckout} //para ir para a página de checkout quando clicar no btão de finalizar compra
            >
              Finalizar Compra
            </button>
          </>
