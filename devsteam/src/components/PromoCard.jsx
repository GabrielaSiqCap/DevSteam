    ...
    <div id="PromoCard" className="promoCard card border-0 overflow-hidden">
      ...
      <div className="card-body d-flex flex-column gap-2">
        ...
        <button
          ...
          //adicionando a ação de clique para +1 item de jogo no carrinho
          //não de faz necessário adicionar uma função de callback ou um item interno na função, exemplo onAddCarrinho(jogo)
